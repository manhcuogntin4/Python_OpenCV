...
#So, how can we know a value we selected is good or notAnswer is, trial and error method.
# But consider a bimodal image 
# (In simple words, bimodal image is an image whose histogram has two peaks). 
# For that image, we can approximately 
# take a value in the middle of those peaks as threshold value, right ? 
